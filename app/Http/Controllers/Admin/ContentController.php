...
class ContentController extends Controller
{
    ...
    public function create(): Response
    {
        ...
        $responsibles = User::select('id', 'name')->arePartners()->orderBy('name')->get();
     ...
     * @return RedirectResponse
     */
    public function showTitles(Content $content): RedirectResponse
    {
        if($content->has_seasons) {
            return redirect()->route('admin.content.season.show-list', $content);
        }

        return redirect()->route('admin.content.chapter.show', $content);
    }
