...
class ContentSeasonChapterController extends Controller
{
     ...
     * @return RedirectResponse
     */
    public function reorderChapters(Content $content, Season $season, Request $request): RedirectResponse
    {
        $request->validate([
        ...
        $this->chapterService->reorderForSeason($season, $request->get('chapters', []));
