...
class LiveEventResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        ...
        return [
            ...
            'has_live_offer' => $liveEvent->has_live_offer,
            'name_offer' => $liveEvent->name_offer,
            'description_offer' => $liveEvent->description_offer,
            'embed_offer' => $liveEvent->embed_offer,
            'offer_available' => $liveEvent->offer_available,
