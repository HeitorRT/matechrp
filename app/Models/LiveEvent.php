...
class LiveEvent extends Model
{
    ...
    /**
     * @return ScheduledNotification[]|MorphMany|Collection
     */
    public function scheduledNotifications(): MorphMany|Collection
    {
        return $this->morphMany(ScheduledNotification::class, 'scheduledable');
    }
