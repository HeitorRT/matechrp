...
class ServicesDTO
{
    ...
    public function __construct(){
        $items = (object) [(object) [
            ...
            'id' => 2,
            'title' => 'COMPUTADORES',
            'text' => 'Resolvemos problemas desde placa mãe, processador, memória, placa de vídeo, fonte, cooler, watercooler, hd, ssd, nvme, m2 sata e gabinete.',
            ...
            'text' => 'Todos os nossos equipamentos passam por testes e inspeções realizados por técnicos capacitados, que garante o funcionamento. Equipamentos seminovos com qualidade, revisados e prontos para uso.',
            ...
            'text' => 'A manutenção preventiva garante uma vida útil maior e um melhor funcionamento dos dispositivos, evitando, por exemplo, perda de componentes importantes, como processador, memória, placa de vídeo e fonte de alimentação. Deve ser realizada, independentemente de o computador apresentar problemas ou defeitos, pelo menos, uma vez por ano.',
