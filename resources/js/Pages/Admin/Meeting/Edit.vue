    ...
    const destroy = () => {
        $q.dialog({
            ...
            componentProps: {
                ...
                message: props.meeting.students.length > 0
                    ? `Há ${props.meeting.students.length} alunos agendados para o encontro, ao excluir, os agendamentos serão excluídos. Tem certeza que deseja excluir esse encontro?`
    ...
    <AuthenticatedLayout>
        ...
        <div class="row q-mb-lg">
            <div class="column col-12 col-md-6 justify-center">
                <div class="app-fs-28 app-fw-700 app-lh-32 text-grey-8"> Editar encontro </div>
