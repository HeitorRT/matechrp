    ...
    <AuthenticatedLayout>
        ...
        <div class="row q-pb-xl">
            <div class="column col-12 col-md-6 justify-center">
                <div class="app-fs-28 app-fw-700 app-lh-32 text-grey-8"> Categorias </div>
                            ...
                            <div class="app-fw-700 app-fs-16">
                                <q-btn icon="more_vert" flat v-if="canCategoryEdit || canCategoryDestroy">
                                    <q-menu :offset="[65, 0]">
                                        <q-list>
                                            <q-item
                                                v-if="canCategoryEdit && !props.row.is_permanent"
                                                clickable
                                            ...
                                            <q-item
                                                v-if="canCategoryDestroy && !props.row.is_permanent"
                                                clickable
