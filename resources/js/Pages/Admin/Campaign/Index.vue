    ...
    function destroy(campaign) {
        $q.dialog({
            ...
            componentProps: {
                ...
                message: campaign.orders_count > 0
                 ? `Há ${campaign.orders_count} pedidos vinculados a esta campanha. Deseja realmente excluir?`
                 : "Deseja realmente excluir?"
            },
        }).onOk(() => {
            useForm().delete(route('admin.campaign.destroy', campaign.id), {
                onSuccess: () => {
                    $q.notify({
                        type: 'positive',
    ...
    <AuthenticatedLayout>
        ...
        <div class="row q-pb-xl">
            <div class="column col-12 col-md-6 justify-center">
                <div class="app-fs-28 app-fw-700 app-lh-32 text-grey-8"> Campanhas </div>
