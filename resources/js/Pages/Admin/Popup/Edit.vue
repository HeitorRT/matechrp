<script setup>
    ...
    const submit = () => {
        form
            ...
            .post(route("admin.popup.update", form.id), {
                preserveState: true,
                preserveScroll: true,
                onSuccess: () => {
                    $q.notify({
    ...
    function destroy() {
        $q.dialog({
            ...
            componentProps: {
                ...
                message: 'Tem certeza que deseja excluir esse pop-up?',
                confirm: true,
            },
        }).onOk(() => {
            useForm().delete(route('admin.popup.destroy', form.id), {
                onSuccess: () => {
                    $q.notify({
                        type: 'positive',
                        message: 'Pop-up excluído com sucesso',
                        position: 'top',
                    })
                }
            })
...
<template>
    <AuthenticatedLayout>
        <Head title="Popup | Editar" />

        <div class="row q-mb-lg">
            <div class="column col-12 col-md-6 justify-center">
                <div class="app-fs-28 app-fw-700 app-lh-32 text-grey-8"> Editar pop-up </div>
                ...
                >
                    ...
                    <q-breadcrumbs-el label="Editar pop-up" class="text-primary" />
                </q-breadcrumbs>
            </div>
