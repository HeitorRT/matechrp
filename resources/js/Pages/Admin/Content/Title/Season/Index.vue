<script setup>
    ...
    const showEditChapterModal = (season, chapter) => {
        ...
        editChapterForm.image = chapter.description;
        editChapterForm.embed = chapter.embed;
    }
    ...
    const showShowChapterModal = (chapter) => {
        ...
        showChapterForm.image = chapter.description;
    ...
    function reOrder(season) {
        let chapters = season.chapters;

        useForm({
            chapters: chapters
        }).post(route('admin.content.season.chapter.reorder', {
            content: props.content.id,
            season: season.id
        }), {
            preserveState: true,
            ...
            onSuccess: () => {
                $q.notify({
                    type: 'positive',
                    message: `Episódios da temporada ${season.name} ordenados com sucesso`,
                    position: 'top',
                })
            }
        });
                            ...
                            <template v-slot:default>
                                <div class="q-pa-md">
                                    ...
                                    >
                                        ...
                                        <draggable
                                            :list="season.chapters"
                                            item-key="index"
                                            tag="tbody"
                                            @change="reOrder(season)"
                                        >
                                                ...
                                                <tr>
                                                    <td style="padding: 0">
                                                        ...
                                                        >
                                                                ...
                                                                >
                                                                    Arraste e solte para ordenar este episódio
                                                                </q-tooltip>
                                                        </q-icon>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td class="text-left" style="width: 20%">
                                                        {{ chapter.main_player.replace(/^./, str => str.toUpperCase()) }}
                                                    </td>
                                                    <td style="width: 5%">
                                                        <q-btn icon="more_vert" flat>
                                                            <q-menu>
                    ...
                    <div class="row q-col-gutter-lg">
                        ...
                        <div class="col-12">
                            <div class="q-gutter-sm row items-center">
                                ...
                                <q-radio v-model="createChapterForm.main_player" val="outros" label="Outros" />
                            </div>
                        </div>
                    ...
                    <div class="row q-col-gutter-lg">
                        ...
                        <div class="col-12">
                            <div class="q-gutter-sm row items-center">
                                ...
                                <q-radio v-model="editChapterForm.main_player" val="outros" label="Outros" />
                            </div>
                        </div>
                    ...
                    <div class="row q-col-gutter-lg">
                        ...
                        <div class="col-12">
                            <div class="q-gutter-sm row items-center">
                                ...
                                <q-radio v-model="showChapterForm.main_player" val="outros" label="Outros" disable/>
                            </div>
                        </div>
