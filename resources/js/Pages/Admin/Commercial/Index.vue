<script setup>
    ...
    const create = () => useForm().get(route('admin.order.create'));

    const edit = (id) => useForm().get(route('admin.order.edit', id));

    const show = (id) => useForm().get(route('admin.order.show', id));
...
<template>
    ...
    <AuthenticatedLayout>
        ...
        <div class="row q-mb-lg" v-if="canOrderStore">
            <div class="col-12 flex justify-end items-end">
                <q-btn
                    color="primary"
                    rounded
                    no-caps
        ...
        <q-card flat class="app-br-16 q-pa-md q-mb-lg">
        ...
        <q-card flat class="app-br-16 q-pa-sm q-mb-lg">
            <q-card-section class="row items-center q-py-sm q-px-lg">
                ...
                <q-chip
                    ...
                    :label="`E-mail contém '${query.filters.email}'`"
                >
                    <q-icon
                        name="cancel"
                        size="xs"
                    ...
                    <template v-slot:body-cell-actions="props">
                        <q-td :props="props">
                            <div class="app-fw-700 app-fs-16">
                                <q-btn icon="more_vert" flat v-if="canOrderUpdate || canOrderCancel">
                                    <q-menu >
                                        <q-list>
                                            <q-item
                                                v-if="canOrderUpdate"
                                            ...
                                            >
                                                ...
                                                <q-item-section no-wrap>
                                                    <div class="q-ml-sm"> Editar pedido </div>
                                                </q-item-section>
                                            </q-item>
                                            ...
                                            >
                                                ...
                                                <q-item-section no-wrap>
                                                    <div class="q-ml-sm"> Visualizar pedido </div>
                                                </q-item-section>
                                            </q-item>
