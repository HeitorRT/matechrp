<script setup>
    ...
    const follow = (id) => useForm().get(route('admin.live-event.follow', id));
    ...
    <AuthenticatedLayout>
        ...
        <div class="row q-pb-xl">
            <div class="column col-12 col-md-6 justify-center">
                <div class="app-fs-28 app-fw-700 app-lh-32 text-grey-8"> Eventos ao vivo </div>
