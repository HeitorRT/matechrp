<script setup>
    ...
    const dateFormated = computed(() => {
        return props.liveEvent.start_at ? date.formatDate(new Date(props.liveEvent.start_at), 'DD [de] MMMM [ás] HH[h]') : null;
    })

    const showLiveEvent = () => useForm().get(route('student.live.show', props.liveEvent.id))
</script>
        ...
        >
            <div class="col-md-6 col-10">
                ...
                <div class="row items-center q-mb-lg">
                    <div class="text-white app-fw-700 app-fs-19 app-lh-24">
                        {{ dateFormated }}
                    </div>
                </div>
                ...
                <div class="q-pt-md">
                    <q-btn
                        ...
                        padding="14px 24px"
                    >
                        <q-icon name="add" size="lg" class="q-ml-sm"/>
